...
```
==21628== Memcheck, a memory error detector
==21628== Copyright (C) 2002-2017, and GNU GPL'd, by Julian Seward et al.
==21628== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==21628== Command: ./test -r xml "test_btree3_small"
==21628== 
==21628== 
==21628== HEAP SUMMARY:
==21628==     in use at exit: 0 bytes in 0 blocks
==21628==   total heap usage: 1,796 allocs, 1,796 frees, 226,792 bytes allocated
==21628== 
==21628== All heap blocks were freed -- no leaks are possible
==21628== 
==21628== For counts of detected and suppressed errors, rerun with: -v
==21628== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
...
==21635== Using Valgrind-3.14.0 and LibVEX; rerun with -h for copyright info
==21635== Command: ./test -r xml "test_btree128_med_rand"
==21635== 
==21635== 
==21635== HEAP SUMMARY:
==21635==     in use at exit: 0 bytes in 0 blocks
==21635==   total heap usage: 2,641 allocs, 2,641 frees, 1,579,584 bytes allocated
==21635== 
